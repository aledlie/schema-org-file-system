...
**Status:** Done — option 1 implemented (cli.py refactored to `run(args)` typed entry points, 2026-07-13); test suite updated and extended with parser-contract tests for preprocess, update-site, and timeline (commit `c29632c`, 2026-07-13).
**Priority:** P3
