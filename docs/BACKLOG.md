...
**Status:** Open — never started. Install verified 2026-08-10 (`nevergrad 1.0.12`), no code written.
...
- **Any accepted re-tune still ships as a calibration doc + backtest report**, same as the 2026-07-26 pass. A weight change sourced from an optimiser is not exempt from the evidence requirement — arguably it needs more, since the search is less inspectable.
