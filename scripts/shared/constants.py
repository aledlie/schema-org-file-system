...
GAME_SPRITE_KEYWORDS = [
  ...
  'glove', 'wand', 'staff', 'ring', 'amulet', 'monster', 'hero', 'ui', 'hud',
  'particle', 'effect', 'explosion', 'smoke', 'blood', 'corner', 'edge',
  'border', 'btn', 'talent', 'segment', 'texture', '2h_axe', '2h_hammer',
  '1h_sword', '1h_axe', 'crossbow', 'assassins_deed', 'atonement',
  'backstab', 'cleave', 'arrow_v', 'arrow_h', 'checkbox', 'radio', 'toggle',
  'add', '_grey', '_gray', '_disabled', '_hover', '_active', '_pressed',
  'rug', 'glow', 'mee', 'gelf', 'salamander', 'blob', 'bubble', 'lever',
  'spine', 'mandible', 'pupils', 'beard', 'bling', 'hiero', 'mustache',
  'scar', 'tattoo', 'earring', 'necklace', 'bracelet', 'glasses', 'mask',
  'hood', 'water', 'lava', 'cloud', 'crystal', 'ore', 'metal', 'wood',
  'over', 'down', 'up', 'left', 'right', 'main', 'bottom', 'top',
  'extension', 'descend', 'ascend', 'mad_carpenter', 'no_more', 'bedroom',
  'front', 'back', 'upper', 'lower', 'middle', 'alive', 'sleeping', 'female',
  'male', 'white', 'black', 'red', 'blue', 'green', 'silver', 'gold',
  'bronze', 'iron', 'steel', 'mithril', 'hills', 'road', 'path', 'bridge',
  'gate', 'fence', 'tentacle', 'shadow', 'altar', 'dungeon', 'throne',
  'torch', 'cloak', 'champion', 'curse', 'warning', 'mouse', 'slider',
  'decal', 'column', 'banner', 'sewer', 'statue', 'pillar', 'orc', 'dwarf',
  'elf', 'hurth', 'helf', 'troll', 'goblin', 'fire', 'ice', 'sand', 'mount',
  'tmount', 'deco', 'entrance', 'shoulders', 'stunned', 'poisoned', 'blind',
  'deaf', 'slowed', 'levitating', 'hungry', 'strained', 'next', 'prev',
  'groove', 'handle', 'cube', 'psf', 'inventory', 'longbow', 'dagger',
  'mace', 'flail', 'spear', 'halberd', 'scimitar', 'smite', 'fireball',
  'lightning', 'heal', 'buff', 'debuff', 'aura', '_selected', '_normal',
  '_highlight', '_glow', '_dark', '_light',
]
