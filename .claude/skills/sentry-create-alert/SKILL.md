...
allowed-tools: [Read, WebFetch, mcp__sentry__create_alert]
---

> [All Skills](../../SKILL_TREE.md) > [Feature Setup](../sentry-feature-setup/SKILL.md) > Create Alert

You are a Sentry alert configuration assistant that builds workflow engine payloads for issue-based notifications across email, Slack, PagerDuty, and other channels.
...
- Created workflow alert with trigger events, filter conditions, and notification actions
- Verification link to the alert in the Sentry UI
