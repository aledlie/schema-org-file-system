...
.agents/
  ...
  commands/
    ...
    code/
      ...
      perf-tuning.md (26 lines)
      review-loop.md (20 lines)
    git/
      git-commit-push.md (3 lines)
      git-commit.md (3 lines)
      pr-create.md (1 lines)
      pr-prepare.md (3 lines)
      pr-resolve-outdated.md (121 lines)
      pr-review.md (80 lines)
...
.github/
  ...
  releases/
    ...
    v1.x/
      ...
      v1.9.2.md (29 lines)
  workflows/
    autofix.yml (57 lines)
    benchmark.yml (129 lines)
    ci.yml (345 lines)
    claude-code-review.yml (46 lines)
    claude-issue-similar.yml (81 lines)
    claude-issue-triage.yml (83 lines)
    claude.yml (55 lines)
    codeql.yml (53 lines)
    docker.yml (71 lines)
    homebrew.yml (27 lines)
    npm-publish.yml (67 lines)
    pack-repository.yml (32 lines)
    perf-benchmark.yml (364 lines)
    pinact.yml (18 lines)
    schema-update.yml (32 lines)
    test-action.yml (61 lines)
  CODEOWNERS (2 lines)
  FUNDING.yml (1 lines)
...
src/
  cli/
    actions/
      workers/
        defaultActionWorker.ts (122 lines)
      defaultAction.ts (430 lines)
      initAction.ts (178 lines)
      mcpAction.ts (7 lines)
      migrationAction.ts (325 lines)
      remoteAction.ts (277 lines)
      versionAction.ts (7 lines)
    prompts/
      skillPrompts.ts (145 lines)
    reporters/
      tokenCountTreeReporter.ts (102 lines)
    cliReport.ts (246 lines)
    cliRun.ts (290 lines)
    cliSpinner.ts (71 lines)
    types.ts (74 lines)
  config/
    configLoad.ts (253 lines)
    configSchema.ts (175 lines)
  ...
  core/
    ...
    treeSitter/
      ...
      loadLanguage.ts (62 lines)
      parseFile.ts (174 lines)
    packager.ts (191 lines)
  mcp/
    prompts/
  ...
  shared/
    ...
    processConcurrency.ts (145 lines)
    sizeParse.ts (27 lines)
    types.ts (1 lines)
    unifiedWorker.ts (179 lines)
  types/
...
tests/
  cli/
    actions/
      workers/
        defaultActionWorker.test.ts (413 lines)
      defaultAction.buildCliConfig.test.ts (39 lines)
      ...
      remoteAction.test.ts (418 lines)
      versionAction.test.ts (26 lines)
    prompts/
      skillPrompts.test.ts (238 lines)
    reporters/
      tokenCountTreeReporter.test.ts (121 lines)
    cliReport.binaryFiles.test.ts (66 lines)
    cliReport.test.ts (333 lines)
    cliRun.test.ts (469 lines)
    cliSpinner.test.ts (204 lines)
  config/
    configLoad.integration.test.ts (162 lines)
    configLoad.test.ts (427 lines)
    configSchema.test.ts (282 lines)
    globalDirectory.test.ts (87 lines)
  core/
    file/
      fileCollect.test.ts (146 lines)
      ...
      fileRead.test.ts (139 lines)
      fileSearch.test.ts (1028 lines)
      fileStdin.test.ts (313 lines)
      fileTreeGenerate.test.ts (90 lines)
      packageJsonParse.test.ts (55 lines)
      permissionCheck.test.ts (281 lines)
      truncateBase64.test.ts (66 lines)
    git/
      gitCommand.test.ts (415 lines)
      gitDiffHandle.test.ts (180 lines)
      gitHubArchive.test.ts (245 lines)
      gitHubArchiveApi.test.ts (156 lines)
      gitLogHandle.test.ts (298 lines)
      gitRemoteHandle.test.ts (88 lines)
      gitRemoteParse.test.ts (331 lines)
      gitRepositoryHandle.test.ts (112 lines)
    metrics/
      calculateGitDiffMetrics.test.ts (356 lines)
      calculateGitLogMetrics.test.ts (425 lines)
      calculateMetrics.test.ts (82 lines)
      calculateOutputMetrics.test.ts (179 lines)
      calculateSelectiveFileMetrics.test.ts (66 lines)
      diffTokenCount.test.ts (277 lines)
    ...
    output/
      ...
      diffsInOutput.test.ts (222 lines)
      flagFullDirectoryStructure.test.ts (119 lines)
      outputGenerate.test.ts (317 lines)
      outputGenerateDiffs.test.ts (251 lines)
      outputSort.test.ts (162 lines)
      outputSplit.test.ts (271 lines)
      outputStyleDecorate.test.ts (169 lines)
    packager/
      copyToClipboardIfEnabled.test.ts (136 lines)
      diffsFunctionality.test.ts (143 lines)
      produceOutput.test.ts (156 lines)
      splitOutput.test.ts (82 lines)
  ...
  mcp/
    ...
    tools/
      ...
      grepRepomixOutputTool.test.ts (739 lines)
      mcpToolRuntime.test.ts (338 lines)
      packCodebaseTool.test.ts (184 lines)
      readRepomixOutputTool.test.ts (198 lines)
    mcpServer.test.ts (284 lines)
  shared/
    logger.test.ts (113 lines)
    patternUtils.test.ts (54 lines)
    processConcurrency.test.ts (170 lines)
    sizeParse.test.ts (31 lines)
    unifiedWorker.test.ts (153 lines)
  testing/
    testUtils.ts (51 lines)
  website/
    cliCommand.test.ts (117 lines)
website/
  .claude/
    skills/
      website-maintainer/
  ...
  client/
    .vitepress/
      config/
        configDe.ts (86 lines)
        configEnUs.ts (64 lines)
        configEs.ts (86 lines)
        configFr.ts (89 lines)
        configHi.ts (86 lines)
        configId.ts (89 lines)
        configIt.ts (89 lines)
        configJa.ts (84 lines)
        configKo.ts (86 lines)
        configPtBr.ts (86 lines)
        configRu.ts (86 lines)
        configShard.ts (256 lines)
        configTr.ts (89 lines)
        configVi.ts (89 lines)
        configZhCn.ts (86 lines)
        configZhTw.ts (86 lines)
      theme/
    ...
    components/
      ...
      Home/
        ...
        TryItResult.vue (144 lines)
        TryItResultContent.vue (669 lines)
        TryItResultErrorContent.vue (161 lines)
        TryItUrlInput.vue (191 lines)
      utils/
        analytics.ts (144 lines)
        cliCommand.ts (69 lines)
    ...
    src/
      de/
        guide/
          development/
            index.md (148 lines)
            using-repomix-as-a-library.md (103 lines)
          tips/
          ...
          remote-repository-processing.md (90 lines)
      ...
      fr/
        guide/
          ...
          remote-repository-processing.md (84 lines)
          repomix-explorer-skill.md (84 lines)
          security.md (65 lines)
          sponsors.md (30 lines)
          usage.md (236 lines)
      ...
      hi/
        guide/
          development/
            index.md (118 lines)
            using-repomix-as-a-library.md (229 lines)
          tips/
          ...
          remote-repository-processing.md (131 lines)
          repomix-explorer-skill.md (84 lines)
      ...
      id/
        guide/
          development/
            index.md (129 lines)
            using-repomix-as-a-library.md (285 lines)
          tips/
          ...
          remote-repository-processing.md (104 lines)
          repomix-explorer-skill.md (84 lines)
      ...
      tr/
        guide/
          ...
          claude-code-plugins.md (163 lines)
          code-compress.md (112 lines)
          command-line-options.md (110 lines)
          comment-removal.md (53 lines)
          community-projects.md (35 lines)
          configuration.md (368 lines)
          custom-instructions.md (43 lines)
      ...
      vi/
        guide/
          development/
            index.md (190 lines)
            using-repomix-as-a-library.md (328 lines)
          tips/
          ...
          remote-repository-processing.md (165 lines)
          repomix-explorer-skill.md (84 lines)
    ...
    src/
      ...
      domains/
        pack/
          ...
          processZipFile.ts (241 lines)
          remoteRepo.ts (126 lines)
      middlewares/
        bodyLimit.ts (12 lines)
        cloudflareGuard.ts (37 lines)
        cloudLogger.ts (126 lines)
        cors.ts (21 lines)
        rateLimit.ts (48 lines)
      utils/
        clientInfo.ts (25 lines)
        dailyRateLimit.ts (23 lines)
      ...
      index.ts (71 lines)
      types.ts (51 lines)
      worker-entry.ts (14 lines)
    .dockerignore (72 lines)
    .gcloudignore (70 lines)
    .gitignore (4 lines)
    .npmrc (1 lines)
    cloudbuild.yaml (83 lines)
    Dockerfile (58 lines)
    package.json (36 lines)
    tsconfig.json (13 lines)
    warmup.mjs (35 lines)
  compose.bundle.yml (51 lines)
  compose.yml (59 lines)
  README.md (33 lines)
