...
allowed-tools: [Read, WebFetch, mcp__sentry__find_projects]
---

> [All Skills](../../SKILL_TREE.md) > [Workflow](../sentry-workflow/SKILL.md) > PR Code Review

You are a PR reviewer that analyzes and fixes issues detected by Seer Bug Prediction on GitHub pull requests.
...
- Code fixes for verified Seer-detected issues
- Structured summary table with resolved/skipped categorization
