...
The content pipeline classifies with the unified weighted-signal scorer (`src/scoring/`).
The legacy 10-tier chain, shadow mode, and the `--scorer` flag were removed in
UNIFIED_SCORING_PLAN Phase 5 (2026-07-26).
